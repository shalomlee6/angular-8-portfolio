...
export const projects: Project[] = [
    {
        ...
        sub:  {
            projects: [
                ...
                {
                    title: 'React-Tube',
                    description: 'A React App To Search And Stream You-Tube content, \n' +
                    'Using You-Tube-API.\n',
                    // tslint:disable-next-line: max-line-length
                    present: '',
                    img: [
                ...
                {
                    title: 'Angular-v8-weather-app',
                    description: 'Angular 8 Web App, using accu-weather-API, \n' +
                    'First Time Using Ngrx Store Architecture, And Using Rxjs Operators For Async Data.\n' +
